...
namespace ConsoleApp2
{
    internal class Program
    {
         ...
         * half_h - половина от шага сетки аргумента
         */
        private static int N;
        private static double b;
        private static double h;
        private static double half_h;
         ...
         * 
         * points[0][0] - начальное значение аргумента
         * points[1][0] - начальное значение функции при заданном аргументе
         */
