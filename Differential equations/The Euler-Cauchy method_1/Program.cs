...
namespace ConsoleApp2
{
    internal class Program
    {
        ...
        private static void Simple_Euler(Stopwatch TimeAlgorithmRun = null)
        {
            ...
            for (int i = 1; i <= N; i++)
            {
                ...
                points[1][i] = points[1][i - 1] + h * func(points[0][i - 1], points[1][i - 1]);
            }
